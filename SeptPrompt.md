...
- ฉากถ่าย ให้เหมาะสมตามสินค้า แสงสว่างปานกลาง
- เพศตัวละคร ผู้ชาย
- ภาษาของสคริปต์คำพูด: 
...
> - เสียงพากย์ไม่ต้องบอกขนาดสินค้า
> - ให้เลี่ยงคำว่า  "สัดส่วน"
---
...
- ตรงตำแหน่ง vertical center ตัวหนังสือตัวหนาเด่นชัด สีเหลือง หรือฟ้า หรือแดง เป็นแคปชั่นภาษา{ไทย/Malay-Eng}ที่คุณคิดว่าคุณชอบที่สุด.

ทำคำสั่งด้านบนก่อนแล้วจงทำตามคำสั่งด้านล่าง
> เช็ก voice over script อีกรอบ ถ้ามีคำภาษาไทยเหล่านี้ 
``` "ต่อเนื่อง" "รายละเอียด" "แน่นอน"  "แนะนำ" "แข็งแรง" "ทนทาน" "โรงแรม" "ทำงาน" "ใช้งาน" ```
ให้เพิ่มเว้นวรรคระหว่างคำ เช่น "ต่อเนื่อง" ให้เขียนว่า " ต่อ เนื่อง "
"แน่นอน"  ให้เขียนว่า  " แน่ นอน"
