...
ต้องการวิดีโอที่ถ่ายเองแบบง่ายๆ ด้วยมือถือ ไม่มีไฟสตูดิโอ ไม่มีกล้องราคาแพง เงาสมจริง
...
ฉาก ห้องเก็บของในบ้านให้ตรงกับสินค้า เช่นสินค้าคือกระเป๋าเดินป่า ฉากต้องเป็นห้องเก็บของเดินป่า แสงสว่างจากแสงไฟในห้อง สถานที่ในไทย

### 1.1 รูปสินค้าวางอยู่

กระเป๋าตั้งอยู่บนโต๊ะ เห็นกระเป๋าชัดเจน

### 1.2 รูปสินค้าในลักษณะถูกใช้งานจริงหรือพร้อมใช้งาน

กระเป๋าอยู่บนหลังตัวละคร ตัวละครใส่ชุดสุ่มสี สุ่มไสตล์
...
## 2) Voice Over Script
- พูดถึง จุดเด่น/ข้อดีหรือเหตุผลที่ควรซื้อ โดยไม่จำเป็นต้องกล่าวคำว่า จุดเด่น ข้อดี หรือ เหตุผลที่ควรซื้อ
- ความยาว **44 - 50 คำ** แบ่งเป็น **2 ส่วน ส่วนละ 22–25 คำ** ส่วนแรกนำไปใช้กับวิดีโอแรก และส่วนที่ 2 นำไปใช้กับวิดีโอที่ 2
...
- กล้อง กล้องเคลื่อนไหวช้าๆ ถ่ายเฉพาะด้านเดียวของสินค้า ถ่ายต่อเนื่องในช็อตเดียว ไม่มีการตัดต่อ
- สินค้า fix กับที่ 100% ไม่ขยับ ไม่หมุน
- ห้าม: ใช้มือจับสินค้า ใช้นิ้วชี้สินค้า จับซิบ ปลดล็อค มือเข้ามาในเฟรม เพิ่มโลโก้เข้าไป

### 3.2 Motion วิดีโอที่ 2

- กล้อง: ไถลกล้อง (Dolly) ไปตามความยาวของเตียงควบคู่กับการ Tilt เพื่อสร้างมิติและความลึก
