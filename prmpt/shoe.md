...
```
[Core + Start]
A close-up vertical video sequence from a first-person perspective (POV) showcasing the specific athletic shoe from the reference image, held in a person's hand.

[Motion]
The video consists of a rapid sequence of quick cuts between different sharply focused camera angles of the shoe. Each cut lasts about 1 second. The cuts move from a full side profile, to the underside tread, to a direct top-down view of the laces, and finally to a close-up of the heel tab. The shoe is visibly rotated or re-positioned quickly between each cut to set up the next angle, giving a fast-paced, "quick cut" demonstration.

[Constraints
The hand must firmly hold and display the shoe throughout the entire duration of the video. The shoe must never be placed on a foot. Strictly maintain the exact design, color, and details of the product identical to the reference image without any modifications. No subtitles or text overlays.
...
[Constraints]
Strictly maintain the exact design, color, and details of the product identical to the reference image without any modifications. No subtitles. 
[Audio]
No talking.
```
